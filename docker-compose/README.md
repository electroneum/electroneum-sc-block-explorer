...
- Running Electroneum JSON RPC client
...
## Configs for different Electroneum clients
...
All of the configs assume, that the Electroneum JSON RPC is running at http://localhost:8545.
